...
export function getPrefs() {
  try {
    ...
    return { theme: 'dark', contrast: 'normal', cameraQuality: '720p', sensitivity: 0.75, voiceURI: '', speechRate: 1, muted: false, language: 'en', notifications: true, twoHandMode: true };
  }
}
